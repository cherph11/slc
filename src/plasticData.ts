...
export const plasticData: PlasticType[] = [
	{
		...
		type: 'PET',
		description:
			'Transparent, lightweight, and strong thermoplastic used for single-serve drink bottles and food trays; widely recycled yet notorious for ending up as ocean microplastics when littered or landfilled.',
		commonItems:
			'Water bottles, Soda bottles, Juice bottles, Food containers, Salad dressing bottles, Oil bottles, Microwave food trays, Clear takeout containers',
	...
	},
	{
		...
		type: 'HDPE',
		description:
			'Tough, opaque plastic for household liquids—milk, detergents, shampoos—valued for chemical resistance; highly recyclable but, when discarded improperly, persists for centuries and clogs waterways and landfills.',
		commonItems:
			'Milk jugs, Shampoo bottles, Detergent bottles, Toiletry containers, Juice bottles, Bleach bottles, Cleaning product bottles, Ice cream tubs',
		image: '/shampoo.png',
		recycle: [
	...
	},
	{
		...
		image: '/pipe.png',
		description:
			'Versatile plastic available in rigid pipes and flexible films; contains chlorine and additives that complicate recycling and release hazardous dioxins and heavy-metal residues when incinerated or burned.',
		commonItems:
			'Plumbing pipes, Credit cards, Medical tubing, Wire insulation, Cling wrap, IV bags, Vinyl flooring, Blister packs',
		recycle: [
	...
	},
	{
		...
		type: 'LDPE',
		description:
			'Thin, flexible film used for grocery bags and bread wraps; lightweight nature lets it blow long distances, litter landscapes, and suffocate marine creatures if not captured for recycling.',
		image: '/plastic_bag.png',
		commonItems:
			'Grocery bags, Bread bags, Packaging film, Frozen food bags, Squeeze bottles, Bubble wrap, Newspaper sleeves, Garbage bin liners',
		recycle: [
	...
	},
	{
		...
		type: 'PP',
		description:
			'Lightweight, heat-resistant polymer common in food tubs, medicine bottles, and straws; relatively safe but slowly fragments into microplastics that accumulate in soil, water, and human bodies.',
		commonItems:
			'Yogurt cups, Bottle caps, Straws, Takeout food containers, Medicine bottles, Ice cream tubs, Chip bags, Hinged lids',
		recycle: [
	...
	},
	{
		...
		description:
			'Foamed or rigid polystyrene—better known as Styrofoam—provides cheap insulation and takeaway packaging, yet shatters into persistent fragments and rarely finds a viable recycling pathway.',
		commonItems:
			'Disposable foam cups, Foam plates, Takeout food boxes, Packing peanuts, Egg cartons, Foam trays, Instant noodle cups',
		recycle: [
	...
	},
	{
		...
		description:
			'Catch-all category for mixed or specialty plastics—polycarbonate, acrylics, bioplastics—often containing BPA; difficult to sort and recycle, frequently ending life in landfills or incinerators.',
		commonItems:
			'Old baby bottles, Reusable water bottles, CDs and DVDs, Eyeglass lenses, Electronics housings, Car parts, Food can linings, Luggage shells',
		recycle: [
